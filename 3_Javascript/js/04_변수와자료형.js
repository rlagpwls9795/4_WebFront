...
var str = "JS 코드를 함수가 아닌 JS 파일 또는 script 태그 내부에 바로 작성하면 HTML 랜더링 시 바로 수행된다."
...
// console.log("함수 외부 num3 : "+ num3); // num3 is not defined => 함수 종료 후에 사용 불가

// ** script 언어는 중간에 에러가 발생하면 해석 멈춤 **

console.log("함수 외부 num4 : "+ num4); // 함수 종료 후에도 사용 가능

// console.log("함수 종료 후 num5 : "+num5); // num5 is not defined => 함수 종료 후에 사용 불가
console.log("함수 종료 후 num6 : "+num6); // 함수 종료 후에도 사용 가능
...
function typeTest(){
    ...
    let temp1=200;
    // let temp1=200; // 변수명 중복 불가 (let은 블록 범위 변수)
    ...
    if(temp1 == 200) {
        ...
        let temp2 = 200;
        const temp3 = 300;
        //temp3 =400; // Assignment to constant variable 상수형 변수에 값을 할당해서 error
    }
    ...
    typeBox.innerHTML=""; //typeBox 요소 내부의 내용을 빈 문자열로 바꿔라 == 내부 내용 삭제

    // const name2; //'const' 선언은 초기화해야 합니다.
    ...
    typeBox.innerHTML += "<br><br> user : "+user+" / "+typeof user; //user : [object Object] / object
    console.log(user); // {id: 'user01', pw: 'pass01', num: 123, a: Array(5)}
